...
public:
	...
	float ComputeDistancePointToSphere(const TSphere& _krSphere, const TVector3& _krPoint); //Distance between point and center of the spheres 
	
	float ComputeDistanceCircleToCircle(const TCircle& _krCircle1, const TCircle& _krCircle2); //Distance between center of the circles 

	float ComputeDistanceCircleToTriangle(const TCircle& _krCircle, const TTriangle2& _krTriangle); //Distance between center of the circle and triangle
